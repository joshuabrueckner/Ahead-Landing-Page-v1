...
<<<<<<< HEAD
  <div className="w-full max-w-5xl px-6 pb-8 md:px-12 md:pb-12 flex-grow flex flex-col justify-start" style={{ paddingTop: 'calc(0.5rem - 5px)' }}>
=======
  <div className="w-full max-w-5xl px-6 pb-8 md:px-12 md:pb-12 flex-grow flex flex-col justify-start" style={{ paddingTop: 'calc(0.5rem - 10px)' }}>
>>>>>>> main
           <Letter />
        </div>
      </main>
      ...
      {/* Footer - Newsletter */}
      <footer className="flex-none w-full bg-[#5a6972] text-[#fdf9f1] border-t border-[#fdf9f1]/10 py-8 px-6 md:px-12 z-20">

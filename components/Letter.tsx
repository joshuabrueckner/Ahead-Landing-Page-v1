      ...
      <div className="flex flex-col w-full max-w-4xl items-center">
        ...
        <div className="font-sans text-base md:text-11px leading-relaxed text-brand-black/90 space-y-6 text-center">
          ...
          <div className="mt-8 mb-4 flex flex-col items-center">
            <svg
              viewBox="0 0 360 80"
              className="h-16 w-auto text-brand-black"
              role="img"
              aria-labelledby="signatureTitle"
            >
              <title id="signatureTitle">Signature of Joshua A. Brueckner</title>
              <text
                x="0"
                y="55"
            ...
            <div className="font-sans text-sm font-medium text-brand-gray tracking-wider">Founder, Ahead</div>
          </div>
